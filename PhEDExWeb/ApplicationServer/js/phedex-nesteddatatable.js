            ...
            */
            buildTable: function() {
                ...
                try {
                    ...
                    this.dataTable.subscribe("nestedCreateEvent", function(oArgs) {
                        var oCallback = {
                ...
                {
                    log('Error in creating nested datatable.. ' + ex.Message, 'error', _me);
                }
                var w = this.dataTable.getTableEl().offsetWidth;
                this.el.style.width = w + 'px';
...
* @namespace PHEDEX.NestedDataTable
* @class ContextMenu
* @param obj {object} reference to the parent PHEDEX.NestedDataTable object that this context-menu applies to.
* @param args {object} reference to an object that specifies details of how the control should operate.
*/
PHEDEX.NestedDataTable.ContextMenu = function(obj,args) {
  var p = args.payload;

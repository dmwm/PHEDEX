  ...
  _construct = function(obj) {
    return {
      ...
      buildOptionsTabview: function() {
        var d = this.dom, mb = d.main_block, form, el,
            opts=d.options, tab, tabView, SelectAll, DeselectAll, Reset, Apply, apply=this.dom.apply;
        ...
        tabView.addTab(tab);
        SelectAll   = new YAHOO.widget.Button({ label:'Select all',   id:'selectallcolumns',   container:'phedex-selectall-columns' });
        ...
        DeselectAll = new YAHOO.widget.Button({ label:'Clear all Nodes', id:'deselectallnodes', container:'phedex-deselectall-nodes' });
...
//        ];
        ...
        this.columnPanel = PHEDEX.Nextgen.Util.CBoxPanel( this, Dom.get('phedex-columnpanel'), { items:items, name:'columns' } );
      }
    }
  }

/**
* The class is used to create agent command module that is used to show agents log information for the given node and agent name.
...
PHEDEX.Module.AgentCommand = function(sandbox, string) {
    ...
    */
    var _dtColumnDefs = [{ key: 'name', label: 'Agent Name' },
                         ...
                         { key: 'message', label: 'Log Message', width:350}];
    ...
    _construct = function() {
        return {
            ...
            */
            ...
            /**
            * This inits the Phedex.AgentCommand module and notify to sandbox about its status.
            * @method initData
            */
            initData: function() {

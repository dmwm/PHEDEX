...
./phedex-proxy.pl --die_on_reject --map yui/=$HOME/public/yui/ --map phedex/datasvc/app/= --verbose --debug --host cmswttest.cern.ch:80 --logfile application-errors.log --redirect_to http://localhost:30002 --urimap /combo=http://localhost/min

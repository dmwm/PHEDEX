...
./phedex-proxy.pl --die_on_reject --map jquery=$HOME/DataLookup/jquery --map yui/=$HOME/public/yui/ --map phedex/datasvc/app/images=images --verbose --debug --host cmswttest.cern.ch:80 --logfile application-errors.log --redirect_to http://localhost:30002

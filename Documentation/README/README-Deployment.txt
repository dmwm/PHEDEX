...
*** Install the software
  ...
  apt-get update
  apt-get install cms+PHEDEX+PHEDEX_2_3_5
  rm -f PHEDEX; ln -s $sw/slc3_ia32_gcc323/cms/PHEDEX/PHEDEX_2_3_5 PHEDEX
...
as will be explained below.  If you used the commands above, use:
  source $sw/slc3_ia32_gcc323/cms/PHEDEX/PHEDEX_2_3_5/etc/profile.d/env.sh

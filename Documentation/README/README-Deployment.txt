...
On Scientific Linux 4 replace "slc3_ia32_gcc323" with "slc4_ia32_gcc345".
  ...
  apt-get update
  apt-get install cms+PHEDEX+PHEDEX_2_5_2
  rm -f PHEDEX; ln -s $sw/slc3_ia32_gcc323/cms/PHEDEX/PHEDEX_2_5_2 PHEDEX
...
following command, but substitute "slc4_ia32_gcc345" if applicable:
  ...
  source $sw/slc3_ia32_gcc323/cms/PHEDEX/PHEDEX_2_5_2/etc/profile.d/env.sh

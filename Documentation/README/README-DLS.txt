...
The following example can be cut&pasted into your config. Please make
sure, that the 3 variables needed are defined properly.
...
1.2. Alternatively you can also use the personal proxies generated by
     "grid-proxy-init", which probably is the method used by most
     sites to run their srmcp or FTS based transfers.

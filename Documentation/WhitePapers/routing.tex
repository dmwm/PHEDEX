...
Copy the file, marking it as in transfer

{\small\begin{verbatim}
  insert into t_Current_state
    values (guid, ``me'', ``in transfer'',
            currenttime, ``suorce_node'');
\end{verbatim}}

Work out where to send the file next:
...
Finally advertise the newly available file

...
\begin{titlepage}
  ...
  \date{\today} % 25 May 2004
  \title{CMS Data Handling White Paper -- Sample Paper}

  \begin{Authlist}
    Tim~Barrass, Simon~Metson\Aref{a}\Instfoot{bristol}{University of Bristol, Bristol, UK},
    Lassi~A.~Tuura\Aref{b}\Instfoot{neu}{Northeastern University, Boston, USA}

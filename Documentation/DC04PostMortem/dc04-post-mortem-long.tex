...
for placing files in mass storage with consistent catalogue information 
...
used in the 
tier 0 would be a preferred system, separating transfers from the GUID metadata insertion.
Since the data challenge came to an end a series of
...
system, and that while this is possible (reference 
ACAT paper) it may not be desirable to
create a "grid of grids" without some significant additional desired functionality. 
It is likely that CMS use of SRB will be phased out before DC05.

...
\begin{figure}[tbp]
\centering
\includegraphics[width=10cm]{srbtmdb.png}
\label{fig:RAL-files}
\caption{States for files assigned to RAL, transfers off the buffer happen as files apear
but loading the buffer cannot keep up with the rate of new files.}
\end{figure} 

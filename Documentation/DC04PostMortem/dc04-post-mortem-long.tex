...
\begin{titlepage}
  ...
  \begin{Authlist}
Tim~Barrass, Owen~Maroney, Simon~Metson, David~Newbold (University of Bristol, UK),
Werner~Jank (CERN, Switzerland), 
Pablo~Garcia-Abia, Jose Maria Hern‡ndez (CIEMAT, Spain),
Anzar~Afaq, Micael~Ernst, Ian Fisk, Yujun~Wu (Fermilab National Laboratory, USA),
Klaus~Rabbertz, Jens~Rehn (University of Karlsruhe, Germany),
Claude~Charlot (IN2P3, LLR, France),
Giacomo~Donvito (INFN-Bari, Italy),
Alessandra~Fanfani, Claudio~Grandi (INFN-Bologna, Italy),
Daniele~Bonacorsi (CNAF-INFN, Italy),
Lassi~Tuura (Northeastern University, USA),
...
\begin{figure}[tbp]
\centering
\includegraphics[width=10cm]{srbtmdb.eps}
\label{fig:RAL-files}

...
insert into t_replica_state (select guid, 'TEST_LAT', 0, 0, 0, 0 from t_files_for_transfer);
insert into t_replica_state (select guid, 'castorgrid_mss', 2, 0, 0, 0 from t_files_for_transfer);

package PHEDEX::Web::API::HistoryBlockLatency;
use warnings;
use strict;
use PHEDEX::Web::SQL;
...
PHEDEX::Web::API::HistoryBlockLatency - all about block latency
...
sub blockLatency
{
    ...
    return { block => PHEDEX::Core::Util::flat2tree($map, PHEDEX::Web::SQL::getHistoryBlockLatency($core,%h)) };
}

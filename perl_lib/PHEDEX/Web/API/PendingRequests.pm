package PHEDEX::Web::API::PendingRequests;
use warnings;
use strict;
...
PHEDEX::Web::API::PendingRequests - transfer requests that have not been acted upon

=head1 DESCRIPTION

Serves pending transfer request information, including the data requested, the
...
sub invoke { return pending_requests(@_); }
...
sub pending_requests
{
    ...
    foreach ( qw / type username node create_since / )
    {
    ...
    my $r = PHEDEX::Web::SQL::getPendingRequests($core, %h);
    return { request => $r };
}

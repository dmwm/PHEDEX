package PHEDEX::CLI::Shift::RequestedQueued;
use Getopt::Long;
use Data::Dumper;
use strict;
use warnings;
...
sub Call { return 'Shift/RequestedQueued'; }
...
sub ResponseIsValid
{
    ...
    # get the arg hash
    my $args = $obj->{PHEDEX}{REQUESTEDQUEUED} || {};
...
sub Report
{
    ...
    # get the arg hash
    my $args = $obj->{PHEDEX}{REQUESTEDDATAISQUEUED} || {};
    print "$_\t:\t$args->{$_}\n" foreach (keys %$args);
}
